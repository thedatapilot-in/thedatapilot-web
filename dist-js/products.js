...
const App = () => {
  ...
  }), "Catalog In Progress • Launching Soon"), /*#__PURE__*/React.createElement(window.SectionEyebrow, null, "Digital Products"), /*#__PURE__*/React.createElement("h1", {
    className: "text-4xl md:text-5xl font-extrabold theme-text-primary mb-4"
  }, "Logic-Ready Templates"), /*#__PURE__*/React.createElement("p", {
    className: "text-lg theme-text-muted font-medium leading-relaxed max-w-2xl mx-auto"
  }, "Automated scripts and frameworks to accelerate your daily data workflows.")))), /*#__PURE__*/React.createElement("main", {
    className: "py-16 px-6 max-w-7xl mx-auto"
  }, /*#__PURE__*/React.createElement("div", {
    className: "grid md:grid-cols-3 gap-6"
  }, (products.items || []).map((product, idx) => /*#__PURE__*/React.createElement(window.ScrollReveal, {
    key: product.id,
    delay: idx * 80
  ...
  }, product.type), /*#__PURE__*/React.createElement("h3", {
  ...
  }, product.currency, product.price), /*#__PURE__*/React.createElement("button", {
    disabled: true,
