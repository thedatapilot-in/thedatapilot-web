...
const App = () => {
  ...
  }, /*#__PURE__*/React.createElement(window.ScrollReveal, null, /*#__PURE__*/React.createElement(window.SectionEyebrow, null, "About Us"), /*#__PURE__*/React.createElement("h1", {
  ...
  }, safeHeader.subtitle)))), /*#__PURE__*/React.createElement("main", {
    className: "flex-grow py-16 px-6"
  }, /*#__PURE__*/React.createElement("div", {
    className: "max-w-4xl mx-auto"
  }, /*#__PURE__*/React.createElement("div", {
    className: "space-y-6 theme-text-secondary text-left"
  }, /*#__PURE__*/React.createElement(window.ScrollReveal, null, /*#__PURE__*/React.createElement("p", {
    className: "text-xl font-medium theme-text-primary leading-relaxed mb-10"
  }, safeHeader.intro.split('Augmented Data Analysts').map((part, i, arr) => i === arr.length - 1 ? part : /*#__PURE__*/React.createElement("span", {
    key: i
  }, part, /*#__PURE__*/React.createElement("strong", null, "Augmented Data Analysts"))))), /*#__PURE__*/React.createElement("div", {
    className: "space-y-12"
  }, /*#__PURE__*/React.createElement(window.ScrollReveal, null, /*#__PURE__*/React.createElement("section", null, /*#__PURE__*/React.createElement("h2", {
    className: "text-2xl font-bold theme-text-primary mb-5 tracking-tight"
  }, safeMission.title), /*#__PURE__*/React.createElement("p", {
    className: "text-lg leading-relaxed"
  }, safeMission.description))), safeMethodology.points.length > 0 && /*#__PURE__*/React.createElement(window.ScrollReveal, null, /*#__PURE__*/React.createElement("section", null, /*#__PURE__*/React.createElement("h2", {
    className: "text-2xl font-bold theme-text-primary mb-5 tracking-tight"
  }, safeMethodology.title), /*#__PURE__*/React.createElement("ul", {
    className: "space-y-4"
  }, safeMethodology.points.map((point, idx) => /*#__PURE__*/React.createElement(window.ScrollReveal, {
    key: idx,
    delay: idx * 60
  ...
  }, /*#__PURE__*/React.createElement("strong", null, point.title, ":"), " ", point.description))))))), /*#__PURE__*/React.createElement(window.ScrollReveal, null, /*#__PURE__*/React.createElement("section", null, /*#__PURE__*/React.createElement("h2", {
    className: "text-2xl font-bold theme-text-primary mb-5 tracking-tight"
  }, safeWhoWeAre.title), /*#__PURE__*/React.createElement("p", {
    className: "text-lg leading-relaxed"
  }, safeWhoWeAre.description)))), /*#__PURE__*/React.createElement(window.ScrollReveal, null, /*#__PURE__*/React.createElement("div", {
    className: "theme-card border theme-border-strong p-10 rounded-[2.5rem] mt-16 shadow-xl"
  }, /*#__PURE__*/React.createElement(window.SectionEyebrow, null, safeCta.title), /*#__PURE__*/React.createElement("p", {
    className: "theme-text-primary font-semibold text-xl mb-6"
  }, safeCta.description), /*#__PURE__*/React.createElement(window.GradientButton, {
    as: "a",
    href: safeCta.buttonLink,
    className: "inline-block px-10 py-4 rounded-xl"
  }, safeCta.buttonText)))))), /*#__PURE__*/React.createElement(Footer, null));
};
