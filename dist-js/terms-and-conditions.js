...
const App = () => {
  ...
  }, safeSections.map((section, idx) => /*#__PURE__*/React.createElement("div", {
    key: idx
  }, /*#__PURE__*/React.createElement("h2", {
  ...
  }, section.content), section.list && section.list.length > 0 && /*#__PURE__*/React.createElement("ul", {
    className: "list-disc pl-6 space-y-2"
  }, section.list.map((item, i) => /*#__PURE__*/React.createElement("li", {
    key: i
  }, item))), section.title.toLowerCase().includes('contact') && /*#__PURE__*/React.createElement("ul", {
  ...
  }), /*#__PURE__*/React.createElement("span", null, contactEmail)), /*#__PURE__*/React.createElement("li", {
    className: "flex items-center gap-3 font-semibold theme-text-primary"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "map-pin",
    size: 18,
    className: "theme-mid-text"
  }), /*#__PURE__*/React.createElement("span", null, businessAddress))))))))), /*#__PURE__*/React.createElement(Footer, null));
};
