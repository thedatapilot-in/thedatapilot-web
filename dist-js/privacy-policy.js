...
const App = () => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "max-w-4xl mx-auto space-y-10 theme-text-secondary font-medium leading-relaxed text-left"
  }, safeSections.map((section, idx) => /*#__PURE__*/React.createElement(window.ScrollReveal, {
    key: idx,
    delay: idx * 50
  }, /*#__PURE__*/React.createElement("div", {
    className: "space-y-4"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "text-2xl font-bold theme-text-primary tracking-tight"
  }, section.title), /*#__PURE__*/React.createElement("p", null, section.content), section.title.toLowerCase().includes('contact') && /*#__PURE__*/React.createElement("ul", {
    ...
    className: "theme-mid-text font-bold hover:underline transition-all"
