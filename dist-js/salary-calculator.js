...
const App = () => {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }), /*#__PURE__*/React.createElement("span", null, "BUILD v3.2.28"))), /*#__PURE__*/React.createElement("div", {
    ...
    className: `p-4 rounded-2xl text-left border text-xs md:text-sm font-bold transition-all flex items-center justify-between ${currentRole === role.id ? "border-brand-500 bg-brand-500/10 theme-mid-text shadow-sm ring-1 ring-brand-500/30" : "border-white/5 bg-white/5 theme-text-muted hover:border-white/10"}`
    ...
    className: "text-xs md:text-sm font-bold uppercase tracking-wider theme-text-secondary"
  }, "Step 2: Current Annual Salary (₹ LPA)"), /*#__PURE__*/React.createElement("span", {
    className: "text-xl md:text-2xl font-black theme-mid-text"
    ...
    className: `py-3.5 px-3 rounded-xl text-center border text-xs md:text-sm font-bold transition-all ${experience === item.id ? "border-brand-500 bg-brand-500/10 theme-mid-text ring-1 ring-brand-500/30" : "border-white/5 bg-white/5 theme-text-muted hover:border-white/10"}`
    ...
    className: `p-4.5 rounded-2xl border transition-all cursor-pointer relative ${targetStack === stack.id ? "border-brand-500 bg-brand-500/10 shadow-md ring-1 ring-brand-500/40" : "border-white/5 bg-white/5 hover:border-white/10"}`
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between mb-1.5"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-extrabold text-sm md:text-lg theme-text-primary"
  }, stack.title), /*#__PURE__*/React.createElement("span", {
    className: "text-[10px] md:text-xs font-bold px-2.5 py-0.5 rounded-full bg-brand-500/20 theme-mid-text"
  }, stack.badge)), /*#__PURE__*/React.createElement("span", {
    className: "text-xs md:text-sm font-black text-emerald-400"
  }, "Avg +", stack.avgHike)), /*#__PURE__*/React.createElement("p", {
    className: "text-xs md:text-sm theme-text-muted font-medium mb-2.5 leading-relaxed"
    ...
    className: "text-xs md:text-sm font-bold uppercase tracking-wider theme-text-muted"
  }, "Projected Post-Transition Package"), /*#__PURE__*/React.createElement("div", {
    className: "text-4xl md:text-5xl lg:text-6xl font-black theme-mid-text tracking-tight"
  }, "₹", calculation.projectedCTC.toFixed(1), " ", /*#__PURE__*/React.createElement("span", {
    className: "text-2xl md:text-3xl font-bold theme-text-muted"
  }, "LPA")), /*#__PURE__*/React.createElement("div", {
    className: "inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs md:text-sm font-extrabold"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "trending-up",
    size: 16
    ...
    className: "text-xs md:text-sm font-bold uppercase tracking-wider theme-text-secondary block"
