                    ...
                    <div className="text-slate-600 space-y-2 leading-relaxed">
                        ...
                        <div className="policy-content space-y-8">
                            ...
                            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 mt-12">
                                <h2 className="text-xl font-bold text-slate-900 mb-3 tracking-tight">Contact Support</h2>
                                ...
                                <div className="flex items-center gap-3 font-semibold text-slate-800">
                                    ...
                                    <a href={`mailto:${contactEmail}`} className="text-cyan-600 hover:underline">{contactEmail}</a>
                                </div>
                            </div>
                        </div>
                    </div>
