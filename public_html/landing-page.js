                ...
                <div className="max-w-7xl mx-auto grid lg:grid-cols-[1.1fr_0.9fr] gap-12 md:gap-16 items-center w-full">
                    <div className="space-y-6 md:space-y-8 text-left">
                        ...
                        <div className="pt-2 md:pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-4 sm:gap-6">
                            ...
                            <a href={window.SITE_DATA.media?.downloads?.brochure || "#"} target="_blank" rel="noopener noreferrer" className="text-cyan-600 font-bold underline underline-offset-4 decoration-2 uppercase tracking-widest text-sm py-2 text-center hover:text-cyan-700 transition-colors">Download Brochure</a>
                        </div>
                    </div>
