        ...
        <div className="min-h-screen theme-text-primary animate-in fade-in duration-700">
            ...
            <header className="pt-40 pb-16 px-6 theme-bg-alt border-b theme-border-strong">
                <div className="max-w-4xl mx-auto text-center">
                    <window.ScrollReveal>
                        <span className="theme-mid-text font-bold uppercase text-xs tracking-widest block mb-3">Digital Products</span>
                        ...
                        <window.ScrollReveal key={product.id} delay={idx * 80}>
                            <window.TiltCard className="h-full">
                                <div className="theme-card border theme-border-strong rounded-3xl p-8 flex flex-col h-full hover:shadow-2xl transition-all duration-300">
                                    <div className="inline-block theme-accent-pill rounded-lg text-[10px] font-black uppercase tracking-widest w-fit mb-5">
                                        {product.type}
                                    </div>
                                    ...
                                    <div className="pt-5 border-t theme-border flex items-center justify-between mt-auto">
                                        ...
                                        <button className="theme-btn-gradient text-white px-6 py-3 rounded-xl font-bold text-sm transition-colors shadow-lg">
                                            Get Access
                                        </button>
                                    </div>
                                </div>
