            ...
            <main className="flex-grow max-w-3xl mx-auto w-full px-6 py-12 space-y-12">
                <div className="text-center space-y-4">
                    <h1 className="text-4xl md:text-5xl font-black tracking-tight">
                        Top 25 SQL Interview Questions at Deloitte India (2026 Edition)
                    </h1>
                    <p className="text-lg theme-text-muted">
                        A comprehensive guide to cracking the technical SQL round at top Indian analytics firms.
                    </p>
                </div>

                <div className="space-y-12 animate-fade-in-up">
                    <section className="space-y-4">
                        <h2 className="text-2xl font-bold border-b theme-border pb-2">1. The Difference Between RANK(), DENSE_RANK(), and ROW_NUMBER()</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-bold border-b theme-border pb-2">2. Find the Second Highest Salary (Without LIMIT)</h2>
                        <p className="theme-text-muted text-sm md:text-base leading-relaxed">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-bold border-b theme-border pb-2">3. What is a CTE (Common Table Expression)?</h2>
                        <p className="theme-text-muted text-sm md:text-base leading-relaxed">
                            A CTE provides a temporary result set that you can reference within another SELECT, INSERT, UPDATE, or DELETE statement. It drastically improves query readability.
                        </p>
                    </section>
                    ...
                    <div className="bg-gradient-to-br from-indigo-900/40 to-blue-900/40 border border-indigo-500/30 rounded-3xl p-8 text-center space-y-6">
                        <h3 className="text-2xl font-black">Want to master all 25 questions?</h3>
