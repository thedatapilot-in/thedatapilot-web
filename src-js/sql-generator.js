        ...
        <window.PageLayout maxWidth="max-w-4xl">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-lg theme-text-muted max-w-2xl mx-auto">
                        Describe what data you want in plain English, and our tool will generate the optimized SQL syntax instantly.
                    </p>
                </div>
                ...
                <div className="theme-card p-6 md:p-8 rounded-3xl shadow-2xl border theme-border space-y-6">
                    ...
                    {showOptions && !isGenerating && !result && (
                        <div className="pt-4 border-t theme-border">
                            <p className="text-sm theme-text-muted mb-3 font-semibold uppercase tracking-wider">Try these examples:</p>
                            <div className="flex flex-wrap gap-2">
                                {SQL_MAPPINGS.map((mapping, idx) => (
                                    <button 
                                        key={idx}
                ...
                {isGenerating && (
                    <div className="flex flex-col items-center justify-center py-12 space-y-4">
                        ...
                        <p className="font-mono text-sm text-cyan-400 animate-pulse">Parsing natural language to syntax tree...</p>
                    </div>
                )}
                ...
                {result && (
                    <div className="space-y-6 animate-fade-in-up">
                        <div className="theme-card rounded-2xl border theme-border overflow-hidden">
                            <div className="bg-black/40 border-b theme-border px-4 py-2 flex justify-between items-center">
                                <span className="font-mono text-xs text-green-400">Query Generated Successfully</span>
                                <button 
                        ...
                        <div className="p-4 bg-blue-900/20 border border-blue-500/30 rounded-xl">
                            ...
                            <p className="theme-text-muted text-sm">{result.explanation}</p>
                        </div>
