...
// ============================================
window.LIVE_THEME = 'blue';       // Choose: crimson, cyan, blue, emerald, indigo, gold, violet, slate, amber
window.ACTIVE_VARIANT = 'glassmorphism'; // Choose: light, cyberDark, glassmorphism, depth3D, minimal, midnight
